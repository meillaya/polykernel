# PolyKernel MLP block (examples/mlp_block.mlir): rmsnorm+matmul+gelu+matmul+add benchmark — H100
...
|---|---|---|---|---|
| NVIDIA H100 (SXM5, sm_90) | 3.1772 | 3.1647 | 1.1195 | 295.2 |
| NVIDIA A100 (80GB, sm_80) | 10.0055 | 9.9785 | 3.4954 | 200.6 |
...
## Per-op roofline (NVIDIA H100 (SXM5, sm_90), unfused)

| op | flops | bytes | AI (flop/byte) | bound | projected ms |
|---|---|---|---|---|---|
| rmsnorm | 25,000,000 | 33,554,432 | 0.75 | memory-bound | 0.01252 |
| matmul_up | 184,683,593,728 | 152,043,520 | 1214.68 | compute-bound | 1.55615 |
| gelu | 200,000,000 | 90,177,536 | 2.22 | memory-bound | 0.03365 |
| matmul_dn | 184,683,593,728 | 152,043,520 | 1214.68 | compute-bound | 1.55615 |
| add_residual | 8,400,000 | 50,331,648 | 0.17 | memory-bound | 0.01878 |
